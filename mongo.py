...
def insert_document():
    ...
    print(f"Документ студента '{full_name}' вставлен с ID: {result.inserted_id}")
...
def main_menu():
    while True:
        ...
        print("="*40)
        print("1. Вставить документ студента")
        print("2. Найти документы")
        print("3. Обновить документ")
